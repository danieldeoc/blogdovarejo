<?php
    ...
    <script type="text/javascript">
    	jQuery(document).ready(function(){
			 jQuery(".maskfone").mask("(99) 99999-999?9");	
			 jQuery(".valid").mask("9");	
		});
    </script>
	<div class="siteContent">             	
    	...
    	<div class="linha" style="margin-right:0; position:relative">
        	 <div class="col col_9 col_lg_8 col_md_7 col_sm_12">
            	...
            	<div id="respond"> 
                	<h3 id="reply-title" class="comment-reply-title">Envie-nos sua mensagem.</h3>
		        	<?php echo $response; ?>       	
                    <form class="formMeio" id="enviaEmail" action="<?php the_permalink(); ?>" method="post">	   
                        <div class="row">                                
                            <label for="name">
                                Nome: <span>*</span> <br>
                        ...
                        <div class="row">   
                        	<a class="button larg ico"  onClick="submitaComment()">Enviar mensagem<span><span class="icon icoMail"></span></span></a>                     
                            <script type="text/javascript">
								function submitaComment(){
									jQuery("#enviaEmail").submit()	
								}
							</script>
                            <br />
                            <br />
