...
<div class="homeIntro">
      <div class="limite">
            ...
            <h1>Nós ajudamos você, varejista e hoteleiro, a <strong>vender mais e melhor, criar ações de marketing e gerir seu negócio</strong> por meio de dicas práticas sempre seguindo as tendências do mercado.            
           </h1>            
            <h2>Venha fazer parte de nossa comunidade!</h2>            
            <div class="calls call1">
            fazer parte como
            <span>VAREJISTA</span>

            
            <a href="<?php echo home_url(); ?>/varejista/" class="button varejistaBt">Ver conte&uacute;do</a>
            </div>
            <div class="calls call2">
            fazer parte como
            <span>Hoteleiro</span>
            <a href="<?php echo home_url(); ?>/category/hotelaria/" class="button secundario hoteleiroBt">Ver conte&uacute;do</a>
    	...
    	<div class="linha limite">
            <div class="col col_12 col_lg_12 col_md_12 col_sm_12">
                ...
                <?php
					...
					query_posts('cat=-1754');
					if ( is_user_logged_in() ) { 
						global $current_user;
						$user_roles = $current_user->roles;
						$user_role = array_shift($user_roles);
						if($user_role == "Hoteleiro"){				
	
						} else if($user_role == "Varejista"){							
							//$posts = new WP_Query(  array( 'cat' => 18 )  );
