...
$catCor = $options['colorCat'.$category_id = get_cat_ID(single_cat_title( '', false ))];
...
<div class="titleBoxCategory limite">
	<h2 class="listageTitle" style="color:<?php echo $catCor?>; border-color:<?php echo $catCor?>">
		<?php printf( __( '%s', 'portobelo-escriba' ), single_cat_title( '', false )); ?>
    	...
    	<div class="linha limite">
            <div class="col col_12 col_lg_12 col_md_12 col_sm_12">
                ...
                <ul class="listagem-posts linha" id="content" 
                	...
                	data-color="<?php echo $catCor ?>" 
                	data-name="<?php printf( __( '%s', 'portobelo-escriba' ), single_cat_title( '', false )); ?>">
