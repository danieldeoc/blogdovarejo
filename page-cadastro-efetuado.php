...
$current_user = wp_get_current_user();
                ...
                echo 'User display name: ' . $current_user->roles[0] . '<br />';
        ...
        <div class="col col_12 col_lg_12 col_md_12 col_sm_12 pageContent">
            ...
            <div class="barradeFerramentas">
                    ...
                    <div class="compartilhe">
                        ...
                        <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink() ?>&title=<?php the_title(); ?>&source=Blog do Varejo" title="Compartilhar no LinkedIn" class="linkedlink shareLink sprites" target="_blank"></a>  
